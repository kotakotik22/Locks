...
public final class LocksItemModelsProperties
{
	...
	public static void register() {
		ItemProperties.register(LocksItems.KEY_RING.get(), new ResourceLocation(Locks.ID, "keys"), (stack, world, entity, seed) ->
		...
		ClampedItemPropertyFunction getter = (stack, world, entity, seed) -> LockItem.isOpen(stack) ? 1f : 0f;
